...
// ⚡ Bolt: Extract log line into a memoized component to prevent re-evaluating string
// parsing styles (O(N) cost per render) for all N logs every time a single line is appended.
