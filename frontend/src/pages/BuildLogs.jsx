...
// ⚡ Bolt: Wrapped LogLine in React.memo to prevent O(N^2) cascading re-renders.
// Since logs are append-only, existing lines do not need to re-render or re-parse their styles.
