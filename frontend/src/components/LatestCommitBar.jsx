...
export default function LatestCommitBar({ owner, repo, branch, onViewCommits }) {
  ...
  // ⚡ Bolt: Prevent cascading re-renders by updating state directly during render
  // when the branch prop changes, rather than inside a useEffect.
  // This avoids an unnecessary extra render cycle and clears the prior commit
  // so it doesn't flash before the new data loads.
